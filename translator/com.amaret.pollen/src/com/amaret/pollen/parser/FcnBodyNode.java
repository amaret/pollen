...
public class FcnBodyNode extends BaseNode implements IScope {

	static final private int FORMALS = 0;  
	static final private int STMTS = 1;   
    static private FcnBodyNode current = null;
    ...
    FcnBodyNode(int ttype, String ttext) {
      	this.token = new CommonToken(ttype, ttext);
    }
  
    static FcnBodyNode current() {
        return current;
    }
