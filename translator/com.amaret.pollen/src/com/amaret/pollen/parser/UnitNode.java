...
public class UnitNode extends BaseNode implements ISymbolNode, IScope, IUnitWrapper, DeclNode.ITypeKind {
    ...
    /**
     * 
     * @return true if this unit was generated by the parser when called on a meta type 
	 * with an import which specified (possibly default) meta arguments.
     */
...
//			return true;
   ...
   public boolean isEnum() {
    ...
    /**
     * 
     * @return true if this unit is a meta type (that is, if the unit definition specifies meta parms).
     */
    public boolean isMeta() {
    	boolean dbg = false;
    	if (flags.contains(Flags.META)) {
//    		if (!this.isGeneratedMetaInstance())
//    			System.out.println("Unit.isMeta && !isGeneratedMetaInstance: " + this.getQualName());
    		return true;
    	}
    	return false;
    }
     ...
     * inserted in the outermost unit symbol table. Key is name, SymbolEntry for import or fcn.
     * 
    ...
    public SymbolEntry lookupName(String name, boolean chkHostScope) {
        ...
        if (name.indexOf(".") != -1) {
        	...
        	while (true) {
        		...
        		if (result.node() instanceof ImportNode && ((ImportNode) result.node()).getExportedUnit() != null)
        			result = null;
